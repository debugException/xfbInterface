 ...
 * @version 1.0.1
 */
public class SmsClientAccessUtil {

	private static SmsClientAccessUtil smsClientToolInstance;
	 ...
	 * @return
	 */
	public static synchronized SmsClientAccessUtil getInstance() {

		if (smsClientToolInstance == null) {
			smsClientToolInstance = new SmsClientAccessUtil();
		}
