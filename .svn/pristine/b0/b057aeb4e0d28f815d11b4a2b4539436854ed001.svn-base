...
//    	inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), AlipayConfig.private_key, AlipayConfig.input_charset));
    	inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), ConfigCache.getKey(), ConfigCache.getInputCharset()));
    	return inputPara;
    }
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
        ...
        if(ConfigCache.getSignType().equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, ConfigCache.getKey(), ConfigCache.getInputCharset());
        }
...
//        	isSign = RSA.verify(preSignStr, sign, AlipayConfig.ali_public_key, AlipayConfig.input_charset);
        	isSign = RSA.verify(preSignStr, sign, ConfigCache.getKey(), ConfigCache.getInputCharset());
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = ConfigCache.getPartner();
