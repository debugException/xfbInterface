...
public interface MemberInfoDao extends IBaseDao {
	...
	int saveMembersInfo(MemberInfo memberInfo) throws Exception;//兼容V1.1.4
	
	/**
	 * 保存头信息，手机相关参数
	 * @param cellphoneParameterInfo
	 * @author shenwu
	 * @return
	 * @throws Exception
	 */
	int saveCellphoneParameterInfo(CellphoneParameterInfo cellphoneParameterInfo) throws Exception;
