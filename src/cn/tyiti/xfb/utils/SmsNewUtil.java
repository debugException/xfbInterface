...
public class SmsNewUtil {
	...
	private final static String I_URL = "http://116.255.238.178:5511/sms.aspx";
	private final static String I_USERID = "4208";
	private final static String I_ACCOUNT = "10690175";
	private final static String I_PASSWORD = "asd263658";
    private final static String I_SMS_END = "【信分宝】";
	/**
	 * <p>
	...
	public static String sendSms(String content, String mobile) {
		...
		return SMS(I_URL, I_USERID, I_ACCOUNT, I_PASSWORD, mobile, content+I_SMS_END, null,
	 ...
	 * @return 返回发送之后收到的信息
	 */
	private static String SMS(String url, String userid, String account,
		...
		try {
			...
			if (sendType != null && (sendType.toLowerCase()).equals("get")) {
				return SmsClientAccessUtil.getInstance().doAccessHTTPGet(
						url + "?" + send.toString(), backEncodType);
			} else {
				return SmsClientAccessUtil.getInstance().doAccessHTTPPost(url,
